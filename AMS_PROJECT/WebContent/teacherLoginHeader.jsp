...
<html lang="en">
<head>
<title>IIIT Bhubaneswar | Teacher Login</title>
<!-- for-mobile-apps -->
	...
	<nav class="navbar navbar-inverse">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><h2>IIIT Bhubaneswar</h2></a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav link-effect">
					<li><a href="index.jsp">Home</a></li>
					<li class="active"><a href="teacherLogin.jsp">Teacher</a></li>
					<li><a href="studentLogin.jsp">Student</a></li>
					<li><a href="mainHeader.jsp" class="scroll">Gallery</a></li>
					<li><a href="mainHeader.jsp" class="scroll">Contact</a></li>
