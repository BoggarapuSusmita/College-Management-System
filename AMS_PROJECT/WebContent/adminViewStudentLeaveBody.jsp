...
<title>Admin | View Student Leave Application</title>
</head>
<style>
table, th, td {
	...
	<thead>
		...
		<tr>
			...
			<%
				...
				{
					%>
					<td><a href="cms.controller.ApproveStudentLeave?regn=<%=t.getRegn()%>&email=<%=t.getEmail()%>&fromdate=<%=t.getFromDate()%>&todate=<%=t.getToDate()%>">Approve</a><br>
					<a>Not Approve</a>
					</td>
			<%
				}
