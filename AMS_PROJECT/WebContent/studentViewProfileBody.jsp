...
<div class="container">
   ...
   %><div id="id01" class="modal">
        <form class="modal-content animate" action="cms.controller.UpdateStudentPhoto" method="post" enctype="multipart/form-data">
