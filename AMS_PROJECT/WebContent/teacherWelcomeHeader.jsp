...
<body>
   ...
   %>
					<h1><a class="navbar-brand" href="teacherWelcome.jsp"><%=s1.getName()%></a></h1>
				</div>
				<!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="cl-effect-13" id="cl-effect-13">
						<ul class="nav navbar-nav">
							<li class="active"><a href="teacherWelcome.jsp">Home</a></li>
							<li><a href="teacherChangePassword.jsp">Change Password</a></li>
							<li><a href="cms.controller.TeacherLogout">Logout</a></li>
						</ul>
					</nav>
				</div>
			</nav>
